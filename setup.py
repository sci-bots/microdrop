...
setup(name='microdrop',
      ...
      install_requires=['blinker', 'path-helpers', 'ipython', 'pyutilib',
                        'pyparsing', 'configobj', 'pyyaml', 'pyzmq',
                        'opencv-helpers', 'pygst-utils', 'geo-util',
                        'pygtkhelpers', 'jsonrpc', 'flatland',
