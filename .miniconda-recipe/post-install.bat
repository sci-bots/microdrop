call Scripts\activate.bat & python -c "import yaml; with open('.condarc', 'w') as output; output.write(yaml.dump({'channels': ['sci-bots', 'microdrop-plugins', 'wheeler-microfluidics', 'conda-forge', 'defaults']})"
